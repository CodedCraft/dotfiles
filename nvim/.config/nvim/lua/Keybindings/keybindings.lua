...
-- Neovim-Keybindings -----------------------------------------------------------------------------
    ...
    -- Move selected lines with J and K in visual, CTRL-j/k  in insert and SPACE-j/k in normal mode
    ...
    -- Capital-Y yanks from the cursor to the end of the line
    vim.api.nvim_set_keymap('n', 'Y', 'y$', { noremap = true, silent = true })


    -- Keep the cursor centered on jumps => already seems to be enabled by default
    -- vim.api.nvim_set_keymap('n', 'n', 'nzzzv', { noremap = true, silent = true })
    -- vim.api.nvim_set_keymap('n', 'N', 'Nzzzv', { noremap = true, silent = true })
    -- vim.api.nvim_set_keymap('n', 'J', 'mzJ`z', { noremap = true, silent = true })


    -- Set undo break points when typing:  , . ! ?
    ...
    -- Go to End of line or begining of text with L and H
...
-- Telescope --------------------------------------------------------------------------------------
    ...
    vim.api.nvim_set_keymap('n', '<leader>ff', "<cmd>lua require('Plugins.Config.telescope').search_any()<cr>", opt)
    ...
    vim.api.nvim_set_keymap('n', '<leader>fh', "<cmd>lua require('Plugins.Config.telescope').help()<cr>", opt)
    vim.api.nvim_set_keymap('n', '<leader>nv', "<cmd>lua require('Plugins.Config.telescope').search_dotfiles()<cr>", opt)


    vim.api.nvim_set_keymap('n', '<leader>ct', [[<cmd>lua require('Plugins.themeChanger')<cr>]], opt)
...
-- Formatter --------------------------------------------------------------------------------------
    ...
    vim.api.nvim_set_keymap("n", "<Leader>af", [[:FormatWrite<CR>]], opt)
